...
const initialComplaints: Complaint[] = [
  { id: "1", category: "Kebersihan", description: "Tandas bahagian lelaki di tingkat bawah kurang bersih. Lantai basah dan tiada sabun.", image_url: null, is_anonymous: false, status: "Dalam Tindakan", created_at: "2026-02-28" },
  { id: "2", category: "Kemudahan", description: "Kipas siling di bahagian utama masjid rosak. Jemaah kurang selesa terutama waktu Zohor.", image_url: null, is_anonymous: true, status: "Selesai", created_at: "2026-02-25" },
  { id: "3", category: "Keselamatan", description: "Lampu kawasan parkir tidak berfungsi. Kawasan gelap pada waktu malam terutama selepas Isyak.", image_url: null, is_anonymous: false, status: "Dalam Tindakan", created_at: "2026-02-20" },
];
