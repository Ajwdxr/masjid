...
/* ─── Mock stats (will be replaced by Supabase aggregations) ─── */
const stats = {
...
const recentActivity = [
  { type: "donation", text: "Ahmad bin Ismail menderma RM 500", time: "1 jam lepas", icon: "💰" },
  { type: "complaint", text: "Aduan kebersihan baru diterima", time: "3 jam lepas", icon: "📝" },
  { type: "announcement", text: "Ceramah Khas Ramadan ditambah", time: "5 jam lepas", icon: "📢" },
  { type: "donation", text: "Tanpa Nama menderma RM 100", time: "1 hari lepas", icon: "💰" },
  { type: "campaign", text: "Kempen surau kampung dikemaskini", time: "2 hari lepas", icon: "🏗️" },
];
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <Link href="/admin/announcements">
          <StatsCard
            ...
            subtitle={`${stats.announcements.active} aktif`}
            icon="📢"
          />
        </Link>
        <Link href="/admin/campaigns">
          <StatsCard
            ...
            subtitle={`RM ${stats.campaigns.collected.toLocaleString("ms-MY")} terkumpul`}
            icon="🏗️"
          />
        </Link>
        <Link href="/admin/donations">
          <StatsCard
            title="Derma"
            value={stats.donations.total.toString()}
            subtitle={`RM ${stats.donations.totalAmount.toLocaleString("ms-MY")} jumlah`}
            icon="💰"
          />
        </Link>
        <Link href="/admin/complaints">
          <StatsCard
            ...
            subtitle={`${stats.complaints.pending} dalam tindakan`}
            icon="📝"
          />
        </Link>
      </div>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <div className="h-2 bg-dark-surface rounded-full overflow-hidden">
                <div
                  ...
                  style={{
                    width: `${(stats.complaints.resolved / stats.complaints.total) * 100}%`,
                  }}
                />
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-3 pt-2">
              <div className="text-center p-3 rounded-xl bg-gold/5 border border-gold/10">
                <p className="text-2xl font-bold gold-text font-[family-name:var(--font-poppins)]">
                  RM 7,175
                </p>
              ...
              <div className="text-center p-3 rounded-xl bg-emerald/5 border border-emerald/10">
                <p className="text-2xl font-bold text-emerald-light font-[family-name:var(--font-poppins)]">
                  40%
                </p>
